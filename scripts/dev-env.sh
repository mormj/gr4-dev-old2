...
export GNURADIO4_PLUGIN_DIRECTORIES="${GR4_PREFIX_PATH}/lib/gnuradio-4/plugins:${GR4_PREFIX_PATH}/lib${GNURADIO4_PLUGIN_DIRECTORIES:+:${GNURADIO4_PLUGIN_DIRECTORIES}}"
